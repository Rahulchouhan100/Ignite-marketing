    ...
    <div className="mt-20">
      ...
      <div className="flex mb-10 items-center justify-between gap-7 flex-wrap">
        ...
        <form
          ...
          className="basis-24 border shadow-md mr-28  p-10 "
        >
          ...
          <input
            ...
            type="email"
            name="email"
            className="border w-96 px-2 py-4 shadow-md rounded-sm mb-5"
          ...
          <textarea
            id="message"
            name="message"
            className="border resize-none w-96 h-32 p-2 mb-5 shadow-md"
